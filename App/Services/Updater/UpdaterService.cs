  ...
  IServiceProvider serviceProvider)
{
  private readonly SparkleUpdater _sparkleUpdater = new CustomSparkleUpdater(
    ...
    new Ed25519Checker(SecurityMode.Strict, ConfigurationService.AppSettings.PublicKey),
  ...
  private async Task HandleUpdateCheckResult(UpdateInfo updateInfo, Window owner)
  {
  ...
  private async Task HandleInstallUpdate(Window owner, UpdateInfo updateInfo)
  {
    _progressWindow = serviceProvider.GetRequiredService<ProgressDialog>();
  ...
  private void AttachUpdateEventHandlers()
  {
    ...
    _sparkleUpdater.CloseApplication += ApplicationService.CloseApplication;
  }
}
